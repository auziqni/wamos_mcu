...
void SerialWrite()
{
    Serial.print("mengirim dalam : ");
    Serial.println((11 - count2send) * 6);
    switch (kondisi_air)
    {
    case 1:
        Serial.print("Air Bagus, ");
        break;
    case 2:
        Serial.print("Air Waspada, ");
        break;
    case 3:
        Serial.print("Air Berbahaya, ");
        break;
    ...
    if (count2send > 10)
    {
        ...
        if (httpCode > 0)
        {
            ...
            if (httpCode == HTTP_CODE_OK)
            {
                ...
                // sending success, wait until next
                count2send = 0;
            }
            else
            {
